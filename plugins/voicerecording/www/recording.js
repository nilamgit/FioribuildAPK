                        ...
                        if (key.indexOf("recording-") !== 0) {
                            ...
                            store.getItem(
                                ...
                                function(data) {
                                    ...
                                    var url = utils.pathForCordova(dataJson.encryptedFilePath);
                                    window.resolveLocalFileSystemURL(
                                        url,
                                        function(entry){
                                            addNewRecording(dataJson, function() {
                                                loadData(currentPos);
                                            });
                                        },
                                        function(error){
                                            // Cannot resolve file(file not found / permission / ...)
                                            // Ignore it here but not to delete it, it can be re-used later.
                                            loadData(currentPos);
                                        }
                                    );
                                },
