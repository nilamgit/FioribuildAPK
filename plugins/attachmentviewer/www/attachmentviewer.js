    ...
    var setupAttachmentViewer = function () {
        ...
        if (platform === 'ios' || platform === 'android' || platform === 'windows') {
            document.addEventListener('click', function (e) {
                ...
                if (element.href) {
                    if (platform !== 'windows' && element.tagName == 'A' && (element.href.indexOf("http") === 0 || element.href.indexOf("https") === 0 || element.href.indexOf("file") === 0 || element.href.indexOf("data") === 0) && element.target == "_blank") {
                        e.preventDefault();
