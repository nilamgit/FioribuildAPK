...
/**
 * Get a format text. Replace the placeholder {num} with arguments,
 * where num is a number starting from 0.
 * 
 * Example:
 * Defines a key in properties file: lbl_greeting = Hello {0} and {1}.
 * var txt = i18n.getFormatText("lbl_greeting", ["Tom", "Jerry"]);
 * 
 * Then txt equals to "Hello Tom and Jerry".
 */
i18n.prototype.getFormatText = function (key, args, defaultValue) {
...
/**
 * Get user locale in the device. 
 */
i18n.prototype.getUserLocale = getUserLocale;
