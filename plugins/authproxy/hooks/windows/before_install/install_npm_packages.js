...
module.exports = function (context) {
    console.log("installing elementtree...");
    ...
    // So we install npm package to projectRoot/plugins/kapsel-plugin-authproxy.
    cp.execSync('npm install --force --no-save --prefix ' + path.join(context.opts.projectRoot, 'plugins', 'kapsel-plugin-authproxy') + ' elementtree', {stdio:'inherit'});
};
