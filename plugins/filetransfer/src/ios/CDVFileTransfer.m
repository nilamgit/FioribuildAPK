...
- (void)updateProgress
{
    if (self.direction == CDV_TRANSFER_DOWNLOAD) {
        ...
        //Kapsel specific change: commenting out the below if block in order to report progress status when bytesExpected is unknown.
