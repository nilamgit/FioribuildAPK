...
/**
 * This error indicates that the specified file does not exist.
 * @memberof sap.EncryptedStorage
 * @name sap.EncryptedStorage#ERROR_FILE_DOES_NOT_EXIST
 * @constant
 */
EncryptedStorage.prototype.ERROR_FILE_DOES_NOT_EXIST = 7;
/**
 * This error indicates that there was an IO error reading or writing to the file.
 * @memberof sap.EncryptedStorage
 * @name sap.EncryptedStorage#ERROR_IO
 * @constant
 */
EncryptedStorage.prototype.ERROR_IO = 8;
