sap.ui.jsview("view.changePasscode", {
    ...
    createContent: function(oController) {
            ...
            document.addEventListener('focusout',(e)=>{
              if(e.relatedTarget==null || e.relatedTarget.tagName.toLowerCase() != 'input'){//if not input element, keyboard would dismiss
                    window.scrollTo(0,0);
                }
            });
            ...
            var checkInputPasscode = function(contextPass){
                var panelHBoxes = getPasscodePolicyTextAndChecksHBoxes(passcodePolicy, contextPass);
            ...
            var buttonDisable = new sap.m.Button( 'button_disable', {
                ...
                press:function(){
                    ...
                    unlockWithFingerprintToggle.setSelected(false);
                    data.fingerprintScanEnabled = false;
                    buttonOK.setVisible(true);
            ...
            var vboxPlaceholder1 = new sap.m.HBox( 'vbox_placeholder1', {
                height:sap.ui.Device.os.ios ? "50px": "25px"
            });
