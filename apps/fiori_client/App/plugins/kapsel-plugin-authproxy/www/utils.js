...
var executeSaveFormCredentialJavascript = function(windowRef, event) {
    var addFormListener = function () {
        if (windowRef) {
            if (device.platform.toLocaleLowerCase() == "android" || device.platform.toLocaleLowerCase() == "ios") {
                windowRef.executeScript({
                    codeFromFile: "www/plugins/kapsel-plugin-authproxy/www/saveFormCredentialsIAB.js"
                });
            } else {
                ...
                var javascriptFile = urlutil.makeAbsolute("plugins/kapsel-plugin-authproxy/www/saveFormCredentialsIAB.js");
    ...
    sap.logon.Core.getSecureStoreObject(function (allowSavingFormCredentials) {
        ...
        module.exports.log("allowSavingFormCredentials is not configured, feature disabled by default");
    ...
    if (fragments) {
        if (fragments[1] == "EVENTOCCURRED") {
            ...
            if (previousEventIdentifier != identifier) {
                ...
                payload = "var event = eventsObject[" + identifier + "];\n"+
