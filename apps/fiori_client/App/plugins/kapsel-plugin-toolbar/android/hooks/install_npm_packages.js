...
module.exports = function (context) {
    ...
    // So we install shelljs to projectRoot/plugins/kapsel-plugin-toolbar.
    cp.execSync('npm install --force --no-save --prefix ' + path.join(context.opts.projectRoot, 'plugins', 'kapsel-plugin-toolbar') + ' shelljs', {stdio:'inherit'});
};
