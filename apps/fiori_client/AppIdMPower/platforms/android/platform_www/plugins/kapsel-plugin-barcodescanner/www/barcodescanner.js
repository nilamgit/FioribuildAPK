cordova.define("kapsel-plugin-barcodescanner.BarcodeScanner", function(require, exports, module) {
/**
...
BarcodeScanner.prototype.scan = function (successCallback, errorCallback, config) {
            ...
            exec(
                function(result) {
                    ...
                    // work around to handle event leaking from CaptureActivity in ZXing library
                    var isAndroid = (device.platform == 'Android');
                    if (isAndroid){
                        if (result.cancelled){
                            console.log('barcode scanning cancelled');
                            var oneTimeConsumer = function(){
                                document.removeEventListener('backbutton',oneTimeConsumer);
                            };
                            document.addEventListener('backbutton',oneTimeConsumer);
                        }
                    }
