           ...
           var useAfaria = function(successCallback, errorCallback, parameter) {
              ...
              var startProxy = function(successCallback, errorCallback, proxyID, proxyURL, proxyExcetpionList ) {
               ...
               var reset = function(successCallback,errorCallback, preferenceToKeep, options) {
                ...
                /*
                 * The UIWebView has been totally removed from iOS Cordova 6.0 and WKWebViewEngine also has been removed. So, Cordova should always use WKWebView. This method only for iOS paltform for UIWebView and WKWebView Switching before. It was deprecated now and probably can't work well.
                 *@deprecated
                 */
