...
var cordova = {
     ...
     */
     ...
     sslCheck: function (){
        var that= this;
            ...
            var server = "https://rrwebapps.ril.com";
   var fingerprint = ["9E 4C 55 80 88 F2 93 F5 05 9D 7A AC CD E4 77 AA 21 B0 14 94 F8 7C D0 13 BE 7A 9B E6 43 C8 46 88","4C 5C 1D 4E A9 58 14 E1 B5 3D 7C AF 05 D6 54 88 B6 C6 A6 4B"];
  ...
  function sslSuccessCallback(message){ 
   ...
   console.log("SSL Check: ", message);},
  function sslErrorCallback(message){ 
  alert("CONNECTION_NOT_SECURE");
         navigator.app.exitApp();
  if (message === "CONNECTION_NOT_SECURE") {
   
   console.log('CONNECTION_NOT_SECURE');
  //alert('CONNECTION_NOT_SECURE');
    ...
    fireDocumentEvent: function (type, data, bNoDetach) {
        ...
        if (rootdetection) {
            rootdetection.isDeviceRooted(function (result) {
                if (result === 1) {
                    alert("Device is rooted you can't open", result);
                    navigator.app.exitApp();
                }
                else {
