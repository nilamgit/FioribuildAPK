...
//kpasel change start
// Fix a ioS Cordova bug in 6.1.0
...
- (void)createViews
{
    ...
    //kapsel change start 
    //Fix a bug in 6.1.0 which cause wkwebsitedatastore.default().httpcookiestore.getallcookies can't give correct cookies sometimes
